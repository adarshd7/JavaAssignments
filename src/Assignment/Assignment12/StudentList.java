...
import static java.util.stream.Collectors.*;
    ...
    public class StudentList {
        public static void main(String[] args) {
            ...
            streamSupplier.get().filter((s) -> s.getBatch() > 2018).
            ...
            Map<String, Double> mo=streamSupplier.get().
                    collect(groupingBy(Student::getGender,averagingDouble(Student::getAge)));
            ...
            Map<String, Long> studentsPerDept= streamSupplier.get().
                    collect(groupingBy(Student::getDept,counting()));
            System.out.println(studentsPerDept);
            System.out.println();

            //TAsk 8
            System.out.println("Task 8: Average percentage in each department");
            Map<String ,Double> avgperDept=streamSupplier.get().
                    collect(groupingBy(Student::getDept,averagingDouble(Student::getAggregate)));
            ...
            streamSupplier.get().
                    filter(s->s.getDept().equals("Electronic")&&s.getGender().equals("Male")).
            ...
            Map<String, Long> studentsInCSE=streamSupplier.get().
                    filter(student -> student.getDept().equals("Computer Science")).
